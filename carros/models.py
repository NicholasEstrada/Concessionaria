...
class MecanicosRevisores(models.Model):
    ...
    especialidade = models.ForeignKey(
        Marcas, on_delete=models.PROTECT, related_name="Mecanico")
    especialidadeTipo = models.ForeignKey(
        TiposCarros, on_delete=models.PROTECT, related_name="Mecanico")
...
class Carro(models.Model):
    ...
    tipo = models.ForeignKey(
        TiposCarros, on_delete=models.PROTECT, related_name="NaN")
    marca = models.ForeignKey(
        Marcas, on_delete=models.PROTECT, related_name="NaN")
    ano = models.ForeignKey(Anos, on_delete=models.ForeignKey)
    revisor = models.ManyToManyField(
        MecanicosRevisores, related_name="Mecanico")
...
class Compra(models.Model):
    ...
    usuario = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="compra")
    processos = models.IntegerField(
        choices=Processos.choices, default=Processos.INTERESSE)


class VendendoUser(models.Model):
    compra = models.ForeignKey(
        Compra, on_delete=models.CASCADE, related_name="Aluga")
    carro = models.ForeignKey(
        Carro, on_delete=models.PROTECT, related_name='carro')
...
class Aluga(models.Model):
    ...
    usuario = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="aluga")
    processos = models.IntegerField(
        choices=Processos.choices, default=Processos.documentos)
...
class AlugandoUser(models.Model):
    aluga = models.ForeignKey(
        Aluga, on_delete=models.CASCADE, related_name="alugango_carro")
    carro = models.ForeignKey(
        Carro, on_delete=models.PROTECT, related_name='veiculo')
